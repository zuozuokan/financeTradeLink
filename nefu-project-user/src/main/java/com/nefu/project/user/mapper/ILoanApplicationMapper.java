...
public interface ILoanApplicationMapper extends BaseMapper<LoanApplication> {
    ...
    //自定义查找自己所有的申请
    @Select("SELECT * FROM loan_application_tab WHERE loan_application_user_uuid = #{userUuid}")
    List<LoanApplication> getLoanApplicationListByUserUuid(String userUuid);
